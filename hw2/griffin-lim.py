...
def main(args):
    ...
    griffin_lim = torchaudio.transforms.GriffinLim(n_fft=n_fft, n_iter=32, win_length=win_size, hop_length=hop_size).cuda()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output', default='data/output/valid/Griffin-Lim', choices=['output/valid/Griffin-Lim', 'output/test/Griffin-Lim'], help='output directory')
